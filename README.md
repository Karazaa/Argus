...
Right now, Argus is based on Unreal Engine version 5.8.1. In order to run Argus you would either need to install Unreal version 5.8.1 via the Epic Games launcher or build Unreal 5.8.1 from source code. 
