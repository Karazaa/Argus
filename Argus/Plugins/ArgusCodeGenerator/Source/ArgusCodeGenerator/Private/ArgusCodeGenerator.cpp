...
{
	// Execute async. If this gets too long, we can use a FScopedSlowTask instead.
	UE::Tasks::Launch(ARGUS_NAMEOF(FArgusCodeGeneratorModule::GenerateCode), []()
	{
		...
		ComponentObserversGenerator::GenerateObserversComponentCode(parsedComponentData);
