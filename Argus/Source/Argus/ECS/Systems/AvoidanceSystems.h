...
private:
	...
	static FVector		GetDesiredDirection(const TransformSystemsArgs& components, bool isInRangeOfObstacles, const GlobalSettingsComponent* settings);
