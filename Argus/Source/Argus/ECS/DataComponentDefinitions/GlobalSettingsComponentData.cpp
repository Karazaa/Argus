...
void UGlobalSettingsComponentData::InstantiateComponentForEntity(ArgusEntity entity) const
{
	...
	GlobalSettingsComponentRef->m_avoidanceObstacleOriginalDirectionInfluence = m_avoidanceObstacleOriginalDirectionInfluence;
	GlobalSettingsComponentRef->m_avoidanceObstacleIndividualWaypointInfluence = m_avoidanceObstacleIndividualWaypointInfluence;
