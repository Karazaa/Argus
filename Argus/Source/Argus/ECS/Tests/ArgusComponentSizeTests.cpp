...
#pragma region FlockingComponent
	...
	ARGUS_LOG(ArgusTestingLog, Display, TEXT("[%s] Size of %s = %d"), ARGUS_FUNCNAME, ARGUS_NAMEOF(FlockingComponent), FlockingComponentSize);
#pragma endregion
...
#pragma region LODComponent
	const size_t LODComponentSize = sizeof(LODComponent);
	netSize += LODComponentSize;
	ARGUS_LOG(ArgusTestingLog, Display, TEXT("[%s] Size of %s = %d"), ARGUS_FUNCNAME, ARGUS_NAMEOF(LODComponent), LODComponentSize);
#pragma endregion
...
#pragma region NearbyObstaclesComponent
	const size_t NearbyObstaclesComponentSize = sizeof(NearbyObstaclesComponent);
	netSize += NearbyObstaclesComponentSize;
	ARGUS_LOG(ArgusTestingLog, Display, TEXT("[%s] Size of %s = %d"), ARGUS_FUNCNAME, ARGUS_NAMEOF(NearbyObstaclesComponent), NearbyObstaclesComponentSize);
#pragma endregion
