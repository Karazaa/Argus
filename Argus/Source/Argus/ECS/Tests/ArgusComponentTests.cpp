...
bool ArgusComponentNavigationComponentResetQueuedWaypointsTest::RunTest(const FString& Parameters)
{
	...
	navigationComponent->m_queuedWaypoints.PushLast(NavigationWaypoint(point0));
	navigationComponent->m_queuedWaypoints.PushLast(NavigationWaypoint(point1));
	navigationComponent->m_queuedWaypoints.PushLast(NavigationWaypoint(point2));
...
#pragma region Test first element of queued waypoints
	...
	(
		...
		navigationComponent->m_queuedWaypoints.First().m_location,
		point0
	);
#pragma endregion
