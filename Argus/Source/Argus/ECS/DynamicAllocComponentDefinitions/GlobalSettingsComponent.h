...
struct GlobalSettingsComponent
{
	...
	ARGUS_COMP_PROPERTY(EditDefaultsOnly, meta = (Category = "Avoidance"))
	float m_avoidanceEntityDetectionPredictionTime = 0.75f;

	ARGUS_COMP_PROPERTY(EditDefaultsOnly, meta = (Category = "Avoidance"))
	float m_avoidanceObstacleDetectionPredictionTime = 0.75f;

	ARGUS_COMP_PROPERTY(EditDefaultsOnly, meta = (Category = "Flocking"))
	float m_flockingVelocityInfluence = 0.3f;

	ARGUS_COMP_PROPERTY(EditDefaultsOnly, meta = (Category = "Obstacles"))
